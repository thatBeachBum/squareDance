function show_pattern() {
	...
	var color_list = ["CornflowerBlue", "Aqua", "Aquamarine", "Blue", "BlueViolet", "Chartreuse", "Coral", "CadetBlue", "Crimson", "Cyan", "DarkCyan", "DarkOrange", "DarkViolet", "DarkOrchid", "Black", "DeepPink", "DeepSkyBlue", "DodgerBlue", "Fuchsia", "GreenYellow", "Gold", "HotPink", "LawnGreen", "LightSeaGreen", "MediumTurquoise", "Red", "SpringGreen", "Turquoise"];
	var the_body = document.getElementById("theBody");

	while (width > 50) {
		var this_div = document.createElement("div");
		var random_color = Math.random() * 28;
